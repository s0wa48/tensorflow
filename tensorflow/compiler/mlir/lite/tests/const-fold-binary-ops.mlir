...
// RUN: litert-opt %s --tfl-elements-attr-roundtrip -canonicalize | litert-opt -tfl-elements-attr-roundtrip=convert-elements-to-dense-resources=false | FILECHECK_OPTS="" FileCheck %s

// RUN: litert-opt %s --tfl-elements-attr-roundtrip | FILECHECK_OPTS="" FileCheck %s
// RUN: litert-opt %s --tfl-elements-attr-roundtrip | litert-opt -tfl-elements-attr-roundtrip=convert-elements-to-dense-resources=false | FILECHECK_OPTS="" FileCheck %s --check-prefix=ROUNDTRIP
